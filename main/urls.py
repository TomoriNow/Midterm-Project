...
urlpatterns = [
    ...
    path('make_admin_flutter/<str:username>', Make_Admin_Flutter.as_view(), name='make-admin-flutter'),
    path('revoke_admin_flutter/<str:username>', Revoke_Admin_Flutter.as_view(), name='revoke-admin-flutter'),
    path('delete_user_flutter/<str:username>', Delete_User_Flutter.as_view(), name='delete-user-admin')
]
